//
//  ReviewerRegisterViewController.swift
//  GDP_IOS
//
...
class ReviewerRegisterViewController: UIViewController {
    ...
    @IBAction func onReviewerRegisterClicked(_ sender: Any) {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if(trans == "reviewerRegisterSegue"){
